...
@archivo_bp.route('/subir-multiples', methods=['POST'])
...
@archivo_bp.route('/info', methods=['POST'])
...
@archivo_bp.route('/listar', methods=['POST'])
...
@archivo_bp.route('/actualizar', methods=['PUT'])
